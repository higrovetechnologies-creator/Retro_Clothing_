...
function getAnnouncements() {
   ...
   * IMPORTANT:
   *
   * If localStorage has never been initialized,
   * seed from ANNOUNCEMENTS.
   *
   * Keep ANNOUNCEMENTS empty in data.js when
   * there should be no default announcement.
   */
...
async function hydrateFromSupabase() {
  ...
  try {
    ...
    if (
       ...
       *
       * because when Supabase has zero
       * announcements, the local cache
       * must also become an empty array.
       *
       * This prevents deleted announcements
       * from remaining visible through
       * localStorage.
       */
...
async function deleteAnnouncement(
   ...
   * IMPORTANT
   *
   * Read the current list, remove the deleted
   * announcement, then explicitly overwrite
   * localStorage.
   */
